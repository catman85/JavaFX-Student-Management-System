...
public class profController {
    @FXML private Label profControllerId;
    @FXML private Label profControllerName;

    @FXML private TableView<Grade> profTableView;
    @FXML private TableColumn<Grade,String> profStudIdColumn;
    @FXML private TableColumn<Grade,String> profStudNameColumn;
    @FXML private TableColumn<Grade,String> profGradeColumn;

    @FXML private ImageView profSignOut;
    ...
    @FXML public void initialize(){
        ...
        profStudNameColumn.setCellValueFactory(
                new PropertyValueFactory<Grade,String>("StudName")
        );

        profGradeColumn.setCellValueFactory(
