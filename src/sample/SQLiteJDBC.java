...
public class SQLiteJDBC {
    public static void makeDb(){
        ...
        try {
            ...
            if(dbExists){
                ...
                String sql1 = "CREATE TABLE PROFESSOR " +
                ...
                String sql2 = "CREATE TABLE ENROLLMENTS " +
                        "(STUDID         int," +
                        " COURSE         TEXT," +
                        " GRADE          int," +
    ...
    public static void insertProf(String name,String email, String password ,String course){
        ...
        try {
            ...
            stmt = c.createStatement();
            String sql = "INSERT INTO PROFESSOR (NAME,EMAIL,PASSWORD,COURSE) " +
    ...
    public static void insertStud(String name ,String email, String password){
        ...
        try {
            ...
            stmt = c.createStatement();
            String sql = "INSERT INTO STUDENTS (NAME,EMAIL,PASSWORD) " +
    ...
    public static ArrayList<Professor> findCoursesUnregistered(Student stud){
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery( "SELECT * FROM PROFESSOR WHERE "+
                    "PROFESSOR.COURSE NOT IN "+
    ...
    public static ArrayList<Enrollment> findCoursesRegistered(Student stud){
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery( "SELECT * FROM PROFESSOR,ENROLLMENTS WHERE " +
                    "PROFESSOR.COURSE = ENROLLMENTS.COURSE AND STUDID = "+studid+";"  );
    ...
    public static void enroll(String CourseName){
        ...
        try {
            ...
            stmt = c.createStatement();
            String sql = "INSERT INTO ENROLLMENTS (STUDID,COURSE) " +
                    "VALUES ("+studid+","+mainController.addThingies(CourseName)+");";
            stmt.executeUpdate(sql);
...
//            SELECT * FROM STUDENTS,ENROLLMENTS WHERE STUDENTS.STUDID = ENROLLMENTS.STUDID AND COURSE = 'r'
            ResultSet rs = stmt.executeQuery( "SELECT * FROM STUDENTS,ENROLLMENTS WHERE" +
                    " STUDENTS.STUDID = ENROLLMENTS.STUDID AND COURSE ="+profscourse+ " ;" );
    ...
    public static void grade(Grade gr){
        ...
        try {
            ...
            stmt = c.createStatement();
            String sql = "UPDATE ENROLLMENTS SET GRADE = "+profsrate+" WHERE " +
                    "(STUDID="+studid+" AND COURSE="+profscourse+");";
            stmt.executeUpdate(sql);
